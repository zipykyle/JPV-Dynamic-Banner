	...
	function createTimeline() {
		...
		function sceneOne(){
			...
			tl
				...
				.from(fr01Line3, frSD, {opacity:0, x: 50, ease:Elastic.easeOut.config(2, 1)}, 2.5)
				.to(fr01Line3, frSD, {opacity:0, x: -50, ease:Elastic.easeOut.config(2, 1)}, 3.5)
				
				.from(fr01Cta, frSD, {scale:0.1 ,opacity:0,  ease:Elastic.easeOut.config(1, 0.3)}, 2.5);
		...
		function sceneThree(){
			...
			tl
				...
				.to(fr03Line2, frSD, {opacity:0, scale:0.09, ease:Elastic.easeOut.config(2, 1)}, 2.5)
		...
		// tl.pause('frame3+=4.5'); // pause the timeline at label:frame3
		// tl.pause('frame4+=3.2'); // pause the timeline at label:frame3
	}
